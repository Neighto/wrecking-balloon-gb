...
SpawnPointBalloon::
    ...
    push hl
    push de
    call RequestPointBalloonSpace ; Returns HL
    LD_DE_HL
    cp a, 0
    jr z, .end
.availableSpace:
    call InitializeEnemyStructVars
    call SetPointBalloonStruct
