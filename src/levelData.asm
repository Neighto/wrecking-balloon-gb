...
W1L1W1:
    DB POINT_BALLOON, OFFSCREEN_BOTTOM_Y, POINT_BALLOON_SPAWN_B
W1L1W1End:

W1L1W2:
    DB POINT_BALLOON, OFFSCREEN_BOTTOM_Y, POINT_BALLOON_SPAWN_A
    DB BALLOON_CACTUS, BALLOON_CACTUS_SPAWN_B, SCRN_X
W1L1W2End:

W1L1W3:
    DB BALLOON_CACTUS, BALLOON_CACTUS_SPAWN_D, 0
    DB POINT_BALLOON, OFFSCREEN_BOTTOM_Y, POINT_BALLOON_SPAWN_C
    DB POINT_BALLOON, OFFSCREEN_BOTTOM_Y, POINT_BALLOON_SPAWN_D
W1L1W3End:
