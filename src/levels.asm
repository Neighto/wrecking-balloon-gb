...
Level1:
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C - 8, SCRN_X, NONE
    LEVEL_WAIT 8
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, 0, NONE
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, EASY
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C, SCRN_X, FOLLOW_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, EASY
    LEVEL_WAIT 8
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B, EASY
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y - 6, SPAWN_X_D, EASY
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y + 4, SPAWN_X_B - 4, EASY
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y - 12, SPAWN_X_C + 4, EASY
    LEVEL_WAIT 6
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B - 2, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B - 16, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A + 2, MEDIUM
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C + 8, 0, FOLLOW_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C + 2, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C + 16, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D - 2, MEDIUM
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_D - 8, SCRN_X, FOLLOW_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C - 6, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C - 19, MEDIUM
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B - 3, MEDIUM
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y, SPAWN_X_B - 19, EASY
    LEVEL_WAIT 4
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B + 4, 0, NONE
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, SCRN_X, NONE
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, EASY
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, EASY
    LEVEL_WAIT 4
    ...
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B, 0, FOLLOW_VARIANT
    LEVEL_WAIT 3
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B + 16, MEDIUM
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y, SPAWN_X_B + 32, EASY
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y, SPAWN_X_B, EASY
    LEVEL_WAIT 16
...
Level2:
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, EASY
    LEVEL_WAIT 4
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, SCRN_X, FOLLOW_VARIANT
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B, 0, PROJECTILE_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C, EASY
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A + 8, MEDIUM
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C, SCRN_X, PROJECTILE_VARIANT
    LEVEL_WAIT 12
    ...
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B - 8, SCRN_X, PROJECTILE_VARIANT
    LEVEL_WAIT 6
    ...
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_D - 4, SCRN_X, FOLLOW_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, EASY
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_B, EASY
    LEVEL_WAIT 2
...
Level5:
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, MEDIUM
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B, SCRN_X, PROJECTILE_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C, 0, FOLLOW_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_C, HARD
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, EASY
    LEVEL_WAIT 8
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_A, EASY
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, EASY
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, 0, PROJECTILE_VARIANT
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, HARD
    LEVEL_WAIT 3
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C, 0, BOMB_VARIANT
    LEVEL_WAIT 9
    LEVEL_SPAWN BIRD, SPAWN_Y_A, 0, EASY
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B, 0, PROJECTILE_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_D, SCRN_X, FOLLOW_VARIANT
    LEVEL_WAIT 8
...
Level7:
    ...
    ; LEVEL_SPAWN PROJECTILE_VARIANT, SPAWN_Y_B, SCRN_X
    ; LEVEL_WAIT 8
