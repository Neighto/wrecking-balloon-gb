...
Level1:
    LEVEL_SPAWN BALLOON_CARRIER, 30, 140, PROJECTILE_VARIANT ; testing
    LEVEL_SPAWN BIRD, 70, 150, EASY ; testing
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, 0, FOLLOW_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM_Y, SPAWN_X_D, EASY
