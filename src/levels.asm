...
Level2:
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B + 16, OFFSCREEN_RIGHT + 4, CARRIER_NORMAL_VARIANT
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B - 18, OFFSCREEN_RIGHT, CARRIER_NORMAL_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_C + 6, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B + 6, BALLOON_MEDIUM_VARIANT
...
Level7:
    ...
    ; LEVEL_SPAWN CARRIER_PROJECTILE_VARIANT, SPAWN_Y_B, OFFSCREEN_RIGHT
    ; LEVEL_WAIT 8
