...
Level1:
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C - 16, OFFSCREEN_RIGHT, CARRIER_PROJECTILE_VARIANT
    LEVEL_WAIT 16
...
Level5:
    ...
    LEVEL_WAIT 5
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_C + 14, BOMB_DIRECT_VARIANT
    ...
    ; LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_C, OFFSCREEN_LEFT, CARRIER_FOLLOW_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_C, BALLOON_HARD_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D, BALLOON_EASY_VARIANT
    ; LEVEL_WAIT 8
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A, BALLOON_EASY_VARIANT
    ...
    ; LEVEL_WAIT 8
    ; LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_A, OFFSCREEN_LEFT, CARRIER_PROJECTILE_VARIANT
    ; LEVEL_SPAWN BIRD, SPAWN_Y_C, OFFSCREEN_RIGHT, BIRD_EASY_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B, BALLOON_EASY_VARIANT
    ; LEVEL_WAIT 8
    ; LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_B, BOMB_FOLLOW_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D, BALLOON_HARD_VARIANT
    ...
    ; LEVEL_WAIT 8
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM-2, SPAWN_X_A, BALLOON_MEDIUM_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM-6, SPAWN_X_B, BALLOON_EASY_VARIANT
    ; LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_C, BOMB_DIRECT_VARIANT
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM-4, SPAWN_X_D, BALLOON_EASY_VARIANT
    ; LEVEL_WAIT 8
    ; LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B, BALLOON_HARD_VARIANT
    ; LEVEL_WAIT 3
    ; LEVEL_SPAWN ANVIL, OFFSCREEN_TOP, SPAWN_X_B, ANVIL_NORMAL_VARIANT ; TESTING
    LEVEL_WAIT 16
