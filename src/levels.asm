...
Level1:
    LEVEL_SPAWN BIRD, SPAWN_Y_C + 8, OFFSCREEN_RIGHT, BIRD_EASY_VARIANT ; testing
    LEVEL_SPAWN PROJECTILE, SPAWN_Y_B, 15, BIRD_EASY_VARIANT ; testing
    LEVEL_WAIT 16 ; testing
