...
Level1:
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C, BALLOON_EASY_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_A, BALLOON_EASY_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN_BALLOON_CARRIER_RIGHT SPAWN_Y_B, CARRIER_NORMAL_VARIANT
    LEVEL_WAIT 6
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C + 4, BALLOON_MEDIUM_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN_BOMB SPAWN_X_A, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 6
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_A, BALLOON_MEDIUM_VARIANT
    LEVEL_WAIT 1
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B, BALLOON_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_D, BALLOON_HARD_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B, BALLOON_EASY_VARIANT
    LEVEL_WAIT 6
    LEVEL_SPAWN_BOMB SPAWN_X_B, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN_BALLOON_CARRIER_LEFT SPAWN_Y_A, CARRIER_NORMAL_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_A, BALLOON_EASY_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_RIGHT SPAWN_Y_C, CARRIER_FOLLOW_VARIANT
    LEVEL_WAIT 5
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_D - 8, BALLOON_EASY_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B, BALLOON_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C, BALLOON_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN_BOMB SPAWN_X_D, BOMB_DIRECT_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C, BALLOON_EASY_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B, BALLOON_EASY_VARIANT
    LEVEL_WAIT 4
    ...
    LEVEL_WAIT 6
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B - 2, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B - 16, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_A + 2, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_LEFT SPAWN_Y_C + 8, CARRIER_FOLLOW_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C + 2, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C + 16, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_D - 2, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_RIGHT SPAWN_Y_D - 8, CARRIER_FOLLOW_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C - 6, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_C - 19, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B - 3, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_BOMB SPAWN_X_B - 19, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN_BALLOON_CARRIER_LEFT SPAWN_Y_B + 4, CARRIER_NORMAL_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_RIGHT SPAWN_Y_A, CARRIER_NORMAL_VARIANT
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_A - 8, BALLOON_EASY_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_RIGHT SPAWN_Y_D, CARRIER_FOLLOW_VARIANT
    LEVEL_WAIT 5
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B + 8, BALLOON_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_D - 10, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_BALLOON_CARRIER_LEFT SPAWN_Y_B, CARRIER_FOLLOW_VARIANT
    LEVEL_WAIT 3
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_B + 32, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN_BOMB SPAWN_X_B + 64, BOMB_DIRECT_VARIANT
    LEVEL_SPAWN_BOMB SPAWN_X_B + 32, BOMB_DIRECT_VARIANT
    LEVEL_SPAWN_BOMB SPAWN_X_B, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 5
    LEVEL_SPAWN_POINT_BALLOON SPAWN_X_D, BALLOON_HARD_VARIANT
...
Level4:
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_C + 8, BALLOON_EASY_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B + 12, BALLOON_EASY_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A - 3, BALLOON_MEDIUM_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D, BALLOON_HARD_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN BIRD, SPAWN_Y_A + 8, OFFSCREEN_RIGHT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_B, OFFSCREEN_RIGHT, BIRD_EASY_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A + 8, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM - 8, SPAWN_X_B, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D - 8, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM - 8, SPAWN_X_C, BOMB_DIRECT_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN BALLOON_CARRIER, SPAWN_Y_B, OFFSCREEN_RIGHT, CARRIER_NORMAL_VARIANT
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_C + 24, BOMB_FOLLOW_VARIANT
    ...
    LEVEL_WAIT 2
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, MIDDLE_SCREEN, BOMB_DIRECT_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_A - 2, OFFSCREEN_RIGHT, BIRD_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D, BALLOON_HARD_VARIANT
    LEVEL_WAIT 6
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_B + 4, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_C + 4, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_WAIT 5
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_B - 8, BOMB_FOLLOW_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_A, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_D, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, SPAWN_X_C, BOMB_FOLLOW_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D, BALLOON_HARD_VARIANT
    ...
    LEVEL_SPAWN BIRD, SPAWN_Y_C + 4, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_B + 4, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN BIRD, SPAWN_Y_A + 4, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D - 4, BALLOON_MEDIUM_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_D + 4, BALLOON_EASY_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN ANVIL, OFFSCREEN_TOP, SPAWN_X_B, ANVIL_NORMAL_VARIANT
    LEVEL_WAIT 8
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_B - 6, BALLOON_EASY_VARIANT
    LEVEL_WAIT 6
    LEVEL_SPAWN BIRD, SPAWN_Y_D, OFFSCREEN_LEFT, BIRD_EASY_VARIANT
    LEVEL_WAIT 4
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A - 2, BALLOON_HARD_VARIANT
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A, BALLOON_EASY_VARIANT
    LEVEL_WAIT 2
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A - 16, BALLOON_EASY_VARIANT ; around here stopped
    LEVEL_WAIT 2
