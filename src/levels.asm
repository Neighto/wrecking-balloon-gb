...
Level4:
    ...
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, SPAWN_X_A, BALLOON_EASY_VARIANT
    LEVEL_WAIT 8
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM, MIDDLE_SCREEN + 8, BALLOON_HARD_VARIANT
    LEVEL_WAIT 2
    ...
    LEVEL_WAIT 8
    LEVEL_SPAWN BOMB, OFFSCREEN_BOTTOM, MIDDLE_SCREEN + 8, BOMB_DIRECT_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM + 6, MIDDLE_SCREEN - 8, BALLOON_HARD_VARIANT
    LEVEL_SPAWN POINT_BALLOON, OFFSCREEN_BOTTOM - 18, MIDDLE_SCREEN + 24, BALLOON_HARD_VARIANT
    LEVEL_WAIT 16
